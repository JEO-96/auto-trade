        ...
        return (
            <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#0a0e17]">
                <div className="max-w-md w-full mx-4 p-8 bg-white/[0.03] border border-white/[0.06] rounded-2xl text-center">
                    ...
                    <h2 className="text-xl font-bold text-white mb-3">승인 대기 중</h2>
                    ...
                    <button
                        onClick={logout}
                        className="px-6 py-2.5 bg-white/[0.06] hover:bg-white/[0.1] border border-white/[0.08] rounded-xl text-sm text-gray-300 transition-colors"
                    >
                        로그아웃
                    </button>
                </div>
