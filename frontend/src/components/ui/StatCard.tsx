        ...
        <div className="glass-panel glass-panel-hover p-6 rounded-2xl flex flex-col justify-between group overflow-hidden relative">
            ...
            <div className="relative z-10">
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-th-text-muted text-[11px] sm:text-xs font-semibold uppercase tracking-wider">{title}</h3>
                    {icon && <div className="text-th-text-muted/40 group-hover:text-th-text-secondary transition-colors">{icon}</div>}
                </div>
