    ...
    return (
        <ModalWrapper isOpen={true} ariaLabelledBy="risk-modal-title">
                    ...
                    <div className="space-y-3">
                        <label className="flex items-start gap-3 cursor-pointer group">
                            ...
                            <span className="text-xs text-gray-400 leading-relaxed group-hover:text-gray-300 transition-colors">
                                <strong className="text-white">원금 손실 위험</strong>을 이해합니다.
                        ...
                        <label className="flex items-start gap-3 cursor-pointer group">
                            ...
                            />
                            <span className="text-xs text-gray-400 leading-relaxed group-hover:text-gray-300 transition-colors">
                                본 서비스는 <strong className="text-white">투자 자문 또는 투자 권유 서비스가 아닙니다.</strong>
                        ...
                        <label className="flex items-start gap-3 cursor-pointer group">
                            ...
                            />
                            <span className="text-xs text-gray-400 leading-relaxed group-hover:text-gray-300 transition-colors">
                                알고리즘 오류, 네트워크 장애, 거래소 점검 등 <strong className="text-white">시스템 사유로 인한 손실</strong>에 대해
                ...
                <div className="flex gap-3 p-6 pt-2">
                    <button
                        onClick={onCancel}
                        className="flex-1 py-2.5 rounded-xl border border-white/[0.06] text-sm font-medium text-gray-400 hover:bg-white/[0.03] transition-colors"
                    >
                        취소
                    </button>
                    <button
