...
export default function KakaoLoginButton() {
    ...
    return (
        <button
            ...
            className="w-full bg-[#FEE500] hover:bg-[#FDD835] text-[#191919] font-semibold py-3 px-4 rounded-lg flex items-center justify-center gap-3 transition-colors mb-4"
        >
