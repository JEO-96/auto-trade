        ...
        <div className="lg:col-span-8">
            <div className="glass-panel p-4 sm:p-6 rounded-2xl min-h-[500px] flex flex-col">
                ...
                <div className="flex justify-between items-center gap-2 mb-6 pb-4 border-b border-white/[0.04]">
                    ...
                    <button
                        aria-label="타임라인 필터"
                        className="flex items-center gap-1.5 text-xs font-medium bg-white/[0.04] hover:bg-white/[0.08] px-3 py-2 rounded-lg border border-white/[0.06] transition-colors text-gray-400 shrink-0"
                    >
