        ...
        >
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-white/[0.04]">
                ...
                <button
                    ...
                    className="text-gray-600 hover:text-gray-400 transition-colors text-xs flex items-center gap-1"
                    aria-label="가이드 닫기"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/[0.04]">
                {steps.map((step, index) => (
                    <button
                        ...
                        className="flex items-center gap-4 px-5 py-4 text-left hover:bg-white/[0.02] transition-colors group"
                    >
                        {/* Step number / check */}
                        <div
                            className={[
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className={[
                                ...
                                step.completed ? 'text-gray-500' : 'text-gray-200',
                            ].join(' ')}>
                                {step.title}
                            </p>
