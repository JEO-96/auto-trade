    ...
    return (
        <div className="min-h-screen bg-background px-6 py-12">
            <div className="max-w-2xl mx-auto">
                ...
                <Link href="/login" className="inline-flex items-center gap-1.5 text-xs text-th-text-muted hover:text-th-text-secondary transition-colors mb-8">
                    <ArrowLeft className="w-3.5 h-3.5" />
                    돌아가기
                </Link>

                <h1 className="text-2xl font-bold text-th-text mb-2">서비스 이용약관</h1>
                ...
                <div className="space-y-8 text-sm text-th-text-secondary leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-base font-semibold text-th-text mb-3">제1조 (목적)</h2>
                        <p>본 약관은 Backtested(이하 "서비스")가 제공하는 자동 매매 알고리즘 서비스의 이용 조건 및 절차, 이용자와 서비스 제공자의 권리·의무 및 책임 사항을 규정함을 목적으로 합니다.</p>
                    </section>

                    <section>
                        <h2 className="text-base font-semibold text-th-text mb-3">제2조 (투자 위험 고지)</h2>
                    ...
                    <section>
                        <h2 className="text-base font-semibold text-th-text mb-3">제3조 (서비스 제공자의 면책)</h2>
                    ...
                    <section>
                        <h2 className="text-base font-semibold text-th-text mb-3">제4조 (서비스 이용 자격)</h2>
                        <ul className="space-y-2 list-disc list-inside">
                    ...
                    <section>
                        <h2 className="text-base font-semibold text-th-text mb-3">제5조 (API 키 보안)</h2>
                        <ul className="space-y-2 list-disc list-inside">
                    ...
                    <section>
                        <h2 className="text-base font-semibold text-th-text mb-3">제6조 (개인정보 처리)</h2>
                        <p>서비스는 카카오 OAuth를 통해 수집한 이용자의 개인정보(이메일, 닉네임)를 서비스 제공 목적으로만 사용하며, 「개인정보 보호법」을 준수합니다. 이용자는 언제든지 계정 삭제를 요청할 수 있습니다.</p>
                    </section>

                    <section>
                        <h2 className="text-base font-semibold text-th-text mb-3">제7조 (서비스 변경 및 중단)</h2>
                        <p>서비스 제공자는 사전 고지 없이 서비스를 변경하거나 중단할 수 있으며, 이로 인한 손해에 대해 책임을 지지 않습니다.</p>
                    </section>

                    <section>
                        <h2 className="text-base font-semibold text-th-text mb-3">제8조 (준거법 및 관할)</h2>
