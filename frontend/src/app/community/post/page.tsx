        ...
        <div className="max-w-3xl mx-auto">
                ...
                <div className="flex items-center gap-4 pt-4 border-t border-white/[0.04]">
                    <button
                        ...
                        className={`flex items-center gap-1.5 text-sm font-medium transition-colors ${
                            !isAuthenticated ? 'text-gray-600 cursor-default' :
            ...
            <div className="glass-panel rounded-2xl p-6">
                ...
                <div className="space-y-3 mb-5">
                    {comments.length === 0 ? (
                        <p className="text-xs text-gray-600 text-center py-6">아직 댓글이 없습니다.</p>
                    ) : (
                ...
                {isAuthenticated ? (
                    <form onSubmit={handleAddComment} className="flex items-center gap-2">
                        <input
                            ...
                            maxLength={500}
                            className="flex-1 bg-white/[0.03] border border-white/[0.06] rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:border-primary/30 transition-colors"
                        />
                    ...
                    <Link
                        href="/login"
                        className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-white/[0.03] border border-white/[0.06] text-sm text-gray-400 hover:text-primary hover:border-primary/20 transition-colors"
                    >
