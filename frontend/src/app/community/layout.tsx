                    ...
                    <div className="flex items-center gap-2">
                        {!isLoading && (
                            isAuthenticated ? (
                                <Link
                                    href="/dashboard"
                                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-th-text-secondary hover:text-th-text hover:bg-white/[0.03] transition-colors"
                                >
