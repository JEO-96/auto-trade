                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        <div className="glass-panel p-5 rounded-2xl">
                            <p className="text-[11px] sm:text-xs text-gray-500 font-medium uppercase tracking-wider mb-2">누적 수익</p>
                        ...
                        <div className="glass-panel p-5 rounded-2xl">
                            <p className="text-[11px] sm:text-xs text-gray-500 font-medium uppercase tracking-wider mb-2">초기 투자금</p>
                            <p className="text-2xl font-bold text-white truncate">₩{Math.round(result.initial_capital).toLocaleString()}</p>
                        </div>

                        <div className="glass-panel p-5 rounded-2xl">
                            <p className="text-[11px] sm:text-xs text-gray-500 font-medium uppercase tracking-wider mb-2">최종 자산</p>
                            <p className="text-2xl font-bold text-white truncate">₩{Math.round(result.final_capital).toLocaleString()}</p>
                        </div>

                        <div className="glass-panel p-5 rounded-2xl">
                            <p className="text-[11px] sm:text-xs text-gray-500 font-medium uppercase tracking-wider mb-2">매매 횟수</p>
                        ...
                        <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
                            ...
                            <div className="glass-panel p-6 rounded-2xl">
                                <div className="flex justify-between items-center mb-4">
                                    ...
                                    <span className="text-[10px] sm:text-xs text-gray-500">변동률 (%) 기준</span>
                                </div>
                    ...
                    <div className="glass-panel rounded-2xl overflow-hidden">
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                <thead>
                                    <tr className="text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-gray-500 border-b border-white/[0.04]">
                                ...
                                return (
                                    ...
                                    >
                                        <div className="p-4 group">
                                            ...
                                            <div className="flex items-center gap-3 text-[11px] sm:text-xs text-gray-500 flex-wrap mb-3">
                                        ...
                                        <div className="flex items-center justify-end gap-1 px-3 py-2 border-t border-white/[0.04]" onClick={(e) => e.stopPropagation()}>
                                            {h.status === 'completed' && (
                                                <>
                                                    <button
                                                        ...
                                                        className="px-3 py-1.5 rounded-lg text-[11px] sm:text-xs font-semibold text-gray-400 hover:text-white hover:bg-white/[0.02] transition-colors"
                                                    >
                                                        상세보기
                                                    </button>
                                                    <button
                                            ...
                                            <button
                                                ...
                                                className="px-2 py-1.5 rounded-lg text-[11px] sm:text-xs text-gray-500 hover:text-red-400 hover:bg-red-400/10 transition-colors"
                                                title="삭제"
                                            >
                        ...
                        <form onSubmit={runBacktest} className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        <label className="text-[10px] sm:text-xs text-gray-500 font-medium mb-1 block">시작일</label>
                                        <input
                                            type="date"
                                            name="start_date"
                                    ...
                                    <div>
                                        <label className="text-[10px] sm:text-xs text-gray-500 font-medium mb-1 block">종료일</label>
                                        <input
                                            type="date"
                                            name="end_date"
                                            value={form.end_date}
