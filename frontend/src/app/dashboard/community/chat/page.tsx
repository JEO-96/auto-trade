        ...
        <PageContainer maxWidth="max-w-3xl">
            ...
            <div className="glass-panel rounded-2xl flex flex-col" style={{ height: 'calc(100vh - 180px)' }}>
                ...
                {loading ? (
                    ...
                    >
                        {messages.length === 0 ? (
                            <p className="text-center text-gray-600 text-xs py-10">아직 메시지가 없습니다. 첫 메시지를 보내보세요!</p>
                        ) : (
                ...
                {/* Input */}
                <form onSubmit={handleSend} className="px-5 py-3 border-t border-white/[0.04] shrink-0">
