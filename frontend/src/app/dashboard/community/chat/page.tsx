        ...
        <PageContainer maxWidth="max-w-3xl">
            ...
            <div className="glass-panel rounded-2xl flex flex-col" style={{ height: 'calc(100vh - 180px)' }}>
                ...
                {loading ? (
                    ...
                    >
                        {messages.length === 0 ? (
                            <p className="text-center text-gray-500 text-xs py-10">아직 메시지가 없습니다. 첫 메시지를 보내보세요!</p>
                        ) : (
                                                    ...
                                                    <div
                                                        className={`px-3.5 py-2 rounded-2xl text-sm leading-relaxed ${
                                                            isMe
                                                                ...
                                                                : 'bg-white/[0.02] text-gray-400 rounded-bl-md'
                                                        }`}
                                                    >
                                                        {msg.content}
                                                    </div>
                                                    <span className="text-[9px] text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
