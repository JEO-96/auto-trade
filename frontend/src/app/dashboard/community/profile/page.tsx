...
import { updateNickname, getUserProfile } from '@/lib/api/community';
                        ...
                        {myPosts.map((post) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.02] border border-th-border-light hover:bg-th-card transition-colors group"
                                >
