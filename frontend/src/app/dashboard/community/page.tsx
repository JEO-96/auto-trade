...
import {
    ...
    MessageCircle, Plus, ChevronLeft, ChevronRight, FlaskConical
} from 'lucide-react';
...
function PostCard({ post, onLikeToggle }: { post: CommunityPost; onLikeToggle: (id: number) => void }) {
            ...
            <div className="flex items-center justify-between pt-2 border-t border-white/[0.04]">
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        className={`flex items-center gap-1 text-xs transition-colors ${post.is_liked ? 'text-red-400' : 'text-gray-500 hover:text-red-400'}`}
                    >
                    ...
                    {totalPages > 1 && (
                        <div className="flex items-center justify-center gap-2">
                            <button
                                ...
                                disabled={page === 1}
                                className="p-2 rounded-lg text-gray-500 hover:text-white hover:bg-white/[0.04] disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                            >
