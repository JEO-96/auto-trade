        ...
        <div className="p-4 pt-6 pr-5 lg:p-8 max-w-6xl mx-auto space-y-8">
            ...
            <div className="bg-surface/60 backdrop-blur-xl rounded-2xl border border-th-border-light overflow-hidden">
                <div className="px-6 py-4 border-b border-th-border-light">
                    <h2 className="text-base font-bold text-th-text">수익률 랭킹</h2>
                </div>
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3.5 text-right">
                                            <div className="flex items-center justify-end gap-1">
                                                ...
                                                <span className="text-[10px] text-th-text-muted ml-0.5">KRW</span>
                                            </div>
                                        </td>
                                        <td className="px-4 py-3.5 text-right">
                                            <span className={`text-sm font-bold tabular-nums ${
                        ...
                        {strategies.map((strategy) => (
                            ...
                            >
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        <p className="text-[10px] text-th-text-muted uppercase tracking-wider mb-0.5">평균 수익률</p>
                                    ...
                                    <div>
                                        <p className="text-[10px] text-th-text-muted uppercase tracking-wider mb-0.5">평균 승률</p>
                                        <p className="text-lg font-bold text-th-text tabular-nums">
                                            {strategy.avg_win_rate}%
                                        </p>
                                    </div>
                                    <div>
                                        <p className="text-[10px] text-th-text-muted uppercase tracking-wider mb-0.5">최고 수익률</p>
                                    ...
                                    <div>
                                        <p className="text-[10px] text-th-text-muted uppercase tracking-wider mb-0.5">총 거래</p>
