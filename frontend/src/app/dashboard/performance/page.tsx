        ...
        <PageContainer>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                ...
                <select
                    ...
                    className="bg-surface border border-th-border rounded-xl px-4 py-2.5 text-sm text-th-text focus:outline-none focus:border-primary/50 transition-colors"
                >
                    {bots.map((bot) => (
                                ...
                                <table className="w-full text-sm">
                                    ...
                                    <tbody>
                                        {performance.weekly_pnl.map((w) => (
                                            <tr key={w.week} className="border-b border-th-border-light hover:bg-th-hover transition-colors">
