                    ...
                    <form onSubmit={handleSaveKey} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-white/[0.02] border border-white/[0.06] rounded-xl p-3 text-sm focus:border-primary/30 transition-colors"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full bg-white/[0.02] border border-white/[0.06] rounded-xl p-3 pr-10 text-sm focus:border-primary/30 transition-colors"
                                />
                                <button
                                    type="button"
                            ...
                            {keys.map((key) => (
                                <div key={key.id} className="bg-white/[0.02] border border-white/[0.06] p-4 rounded-xl flex justify-between items-center group hover:border-primary/20 transition-colors">
                                    ...
                                    <button
                                        ...
                                        aria-label="API 키 삭제"
                                        className="text-gray-500 hover:text-red-400 opacity-0 group-hover:opacity-100 transition-all p-2 hover:bg-red-500/[0.08] rounded-lg disabled:opacity-50"
                                    >
                                        {deleting === key.id ? (
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex flex-wrap gap-3 mb-4">
                                <a
                                    ...
                                    className="bg-white/[0.02] hover:bg-white/[0.03] text-white px-4 py-2 rounded-lg border border-white/[0.06] flex items-center gap-2 transition-colors text-xs font-medium"
                                >
