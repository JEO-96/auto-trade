...
import { Key, LogOut, Settings, LayoutDashboard, BarChart2, Menu, X, Shield, MessageSquare, UserCircle, Radio, TrendingUp, Trophy, Briefcase } from 'lucide-react';
            ...
            <div className="min-h-screen bg-background text-th-text flex overflow-hidden relative">
                ...
                `}>
                    ...
                    <nav aria-label="대시보드 메뉴" className="flex-1 px-3 py-4 space-y-0.5">
                        ...
                        <NavItem href="/dashboard/portfolio-backtest" icon={<Briefcase className="w-[18px] h-[18px]" />} label="포트폴리오 백테스트" />
                    ...
                    <div className="p-3 mt-auto border-t border-white/[0.04]">
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-[10px] sm:text-xs text-th-text-muted truncate">
                                    {user?.email || ''}
                                </p>
                            </div>
