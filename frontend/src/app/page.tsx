        ...
        <main className="flex min-h-screen flex-col relative overflow-hidden bg-background">
            ...
            <header className="fixed top-0 w-full z-50 bg-background/60 backdrop-blur-xl border-b border-th-border-light py-4 px-6 md:px-12">
                <div className="max-w-6xl mx-auto flex items-center justify-between">
                    ...
                    <Link
                        href="/dashboard"
                        className="px-5 py-2 text-sm font-semibold bg-th-border hover:bg-th-hover text-th-text rounded-lg transition-all border border-th-border flex items-center gap-2"
                    >
            ...
            <div className="z-10 max-w-5xl w-full mx-auto flex flex-col items-center pt-36 pb-20 px-6">
                ...
                <div className="text-center mb-24 animate-fade-in-up">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                        ...
                        <Link href="/community" className="px-8 py-3.5 rounded-xl border border-th-border hover:bg-th-hover transition-all flex items-center justify-center gap-2 text-sm font-semibold text-th-text-secondary">
                            커뮤니티 둘러보기
                        </Link>
                    </div>
                </div>
                ...
                <footer className="w-full border-t border-th-border-light pt-8 pb-4">
                    <div className="flex flex-col items-center gap-6 text-xs text-th-text-muted">
                        ...
                        {/* 사업자 정보 */}
                        <div className="text-center leading-relaxed text-th-text-muted space-y-1 [text-wrap:pretty]">
                            <p>
                                <span className="text-th-text-muted">플레이위드</span> | 대표 주은오 | 사업자등록번호 880-58-00862
                            </p>
