"""
QuickSwing1hStrategy - 1시간봉 퀵 스윙 전략

빠른 익절 + 엄격한 진입으로 높은 승률을 추구하는 단기 스윙:
- ADX > 20 (트렌드 품질 강화)
- ATR SL 1.5x, TP 2.0x, trailing 1.8x (빠른 익절)
- RSI 과열 72 (엄격한 진입)
...
class QuickSwing1hStrategy(BaseStrategy):
    """1시간봉 퀵 스윙 전략 (빠른 익절, 높은 승률)."""
