"""
Steady Compounder V1 - 검증 완료된 백업 버전 (2026-03-14)

원본: steady_compounder.py
백테스트 성과: BTC/ETH/XRP/SOL 4h 3년 기준 +109% / 146회 거래
절대 수정 금지. 원본 변경 시 비교 기준으로 사용.
"""
import pandas as pd
import numpy as np
...
class SteadyCompounderV1Strategy(BaseStrategy):
    """
    Steady Compounder V1 - 주간 1~2% 목표의 고승률 스윙 전략 (백업)
